    ...
    <SafeAreaView className='h-full bg-themeBg'>
      <ScrollView className=''>
        ...
        <View className='flex justify-center items-center h-full'>
          <View className='mb-5'>
            <Post name='Mittens' username='mittens123' petImage='' postImage='' caption='Out in the park and having a good time!Out in the park and having a good time!Out in the park and having a good time!' />
