...
export type GetAllPostsQuery = { __typename?: 'Query', getAllPosts: { __typename?: 'AllPostsResponse', posts: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null, Owner?: { __typename?: 'Owner', id: string, authId: string, name?: string | null, username: string, location?: string | null, followingCount?: number | null } | null } }> } };
...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'PostResponse', post?: { __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null, Owner?: { __typename?: 'Owner', id: string, authId: string, name?: string | null, username: string, location?: string | null, followingCount?: number | null } | null } } | null } };
...
export type GetPostsByPetIdQuery = { __typename?: 'Query', getPostsByPetId: { __typename?: 'PostsResponse', posts: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null } }> } };

export type GetFollowingQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFollowingQuery = { __typename?: 'Query', getFollowing: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null } }> };

export type GetForYouQueryVariables = Exact<{ [key: string]: never; }>;


export type GetForYouQuery = { __typename?: 'Query', getForYou: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null } }> };
