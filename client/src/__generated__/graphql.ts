...
export type GetFeedQuery = { __typename?: 'Query', getFeed: { __typename?: 'FeedResponse', forYou: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null }, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null } }>, following: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, author: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, followerCount?: number | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null }, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null } }> } };
