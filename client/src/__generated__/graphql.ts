...
export type GetPostsByPetIdQuery = { __typename?: 'Query', getPostsByPetId: { __typename?: 'PostsResponse', posts: Array<{ __typename?: 'Post', id: string, petId: string, description?: string | null, likesCount: number, createdAt: any, updatedAt: any, Media: { __typename?: 'Media', id: string, name: string, url: string, path: string, type?: string | null, aspectRatio?: number | null }, Author?: { __typename?: 'Pet', id: string, username: string, name: string, type: PetType, description?: string | null, location?: string | null, postsCount?: number | null, followerCount?: number | null, totalLikes?: number | null, ownerId?: string | null, ProfilePicture?: { __typename?: 'ProfilePicture', id: string, name: string, url: string, path: string, type: string } | null } | null }> } };
